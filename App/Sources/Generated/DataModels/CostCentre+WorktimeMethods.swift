...
public extension CostCentre {
    /// Inserts a new `CostCentre` entry into the provided context.
    ///
    /// - Parameter context: The managed object context that will own the inserted object.
    /// - Returns: The inserted `CostCentre` instance.
    @discardableResult
    static func insert(into context: NSManagedObjectContext) -> CostCentre {
        CostCentre(context: context)
    }
